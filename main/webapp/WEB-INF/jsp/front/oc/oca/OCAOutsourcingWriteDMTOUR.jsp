										...
										<table summary="">
											...
											<tbody>
												...
												<c:if test="${info.agentEmpTelYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">담당자 연락처(휴대폰)</span></th>
														<td>
															<input type="text" name="agentEmpTel" title="담당자 연락처" class="inputType1 mobileChk" maxlength="13" />
														</td>
													</tr>
												</c:if>										
												...
												<c:if test="${info.sllrCtelYn eq 'Y'}">
													<tr>
														...
														<td>
															<input type="text" name="sllrCtel" title="판매자 연락처" class="inputType1 mobileChk" maxlength="13" />
														</td>
													</tr>
												</c:if>
											</tbody>
								...
								<c:if test="${info.customerInfoYn eq 'Y'}">
									...
									<div class="boardType2 mt15">
										<table summary="">
											...
											<tbody>
												<!-- 인입경로 -->
												<c:if test="${info.funnelYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">인입경로</span></th>
														<td>
															<select name="funnel" title="인입경로">
																<option value="">[경로선택]</option>
																<option value="1">온라인</option>
																<option value="2">홈쇼핑</option>
																<option value="5">투어캐빈</option>
															</select>
														</td>
													</tr>
												</c:if>		
												...
												<c:if test="${info.hpYn eq 'Y'}">
													<tr>	
														...
														<td>
															...
															<input type="text" name="hp" title="고객 연락처" class="inputType1 mobileChk" maxlength="13" />
														</td>
													</tr>
												</c:if>
												...
												<c:if test="${info.dmTourNumYn eq 'Y'}">
													<tr>	
														...
														<td>
															<input type="text" name="dmTourNum" title="대명투어몰 예약번호" style="float:left;" class="inputType1" maxlength="20" />&nbsp;&nbsp;
															<p class="red" style="float:left;padding-left:10px;"> * 동일 예약번호 다구좌 가입 시, 구분 번호(-1,-2,-3  …) 추가 입력 必 ex) 0000000 – 1 <br />
															* 예약번호는 <b>여덟자리</b> 입니다.<br />
															 &nbsp;&nbsp; (행사번호와 상이합니다.)<br />
															* 예약번호 없는 경우, 0000 입력</p>
