											...
											<tbody>
												...
												<c:if test="${info.memoYn eq 'Y'}">
													<tr>	
														...
														<td>
															<textarea name="memo" title="메모" class="inputType4 notRequired" style="height:60px;" maxlength="2000">*희망 여행일과 인원수를 반드시 입력해주세요. 서비스 신청 후 전화를 드립니다.
								...
								<c:if test="${info.termsYn eq 'Y'}">
									...
									<div class="termDiv mt40">
										...
										<div class="termBox">
											...
											<p>※ 거부에 따른 불이익 : 위 제공사항은 해외리조트 예약 신청에 반드시 필요한 사항으로 거부하실 경우, 서비스 이용이 불가함을 알려드립니다.</p>
											<p>본인은 멤버십서비스(해외리조트) 신청에 대한 내용을 확인하였음을 최종 동의합니다.</p>
											<p>최종 사용자를 위와 같이 하는 것에 동의하며, 이에 발생되는 제반 문제는 계약자 본인에게 귀속됨을 확인합니다.</p>
										</div>
									</div>
								</c:if>
