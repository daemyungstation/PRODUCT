										...
										<table summary="">
											...
											<tbody>
												...
												<c:if test="${info.mainContTypeYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">이용서비스</span></th>
														<td>
															<select id="mainContType" name="mainContType" title="이용서비스" class="inputType1 notRequired">
																<option value="">선택하세요.</option>
																...
																<option value="어학연수(화상영어)">어학연수(화상영어)</option>
																...
																<option value="가전전환">가전전환</option>
																<option value="기타">기타</option>
															</select>
															(해외여행/크루즈/웨딩/웨딩홀/어학연수/골프 등)
														</td>
													</tr>
												</c:if>												
...
<!-- 
									<div class="termDiv mt40">
										...
										<div class="termBox">
											...
											<p>- 제공받는자 : 주식회사 해외교육, 주식회사 디세이브, 주식회사 케어빌리지, 주식회사 브랜즈웰, 주식회사 베스트허니문, 주식회사 골든벨트래블앤크루즈, 주식회사 소노호텔앤리조트, 쥬드</p>
											<p>- 제공하는 개인정보 항목 : 성명, 연락처(휴대전화번호)</p>
											<p>- 제공받는 자의 개인정보 이용 목적 : 신청 서비스 상담 및 컨텐츠 제공, 상담을 위한 일정 및 정보제공(전화, E-DM발송)</p>
											<p>- 보유기간 : 처리 종료 시</p>
											<p>※ 귀하께서는 개인정보제공 및 활용에 거부할 권리가 있습니다.</p>
											<p>&nbsp;&nbsp;&nbsp; 거부에 따른 불이익 : 위 제공사항은 대명아임레디 하이브리드서비스 신청에 반드시 필요한 사항으로 거부할 경우 서비스 이용이 불가함을 알려드립니다.</p>
										</div>
									</div>		
-->							
								</c:if>
