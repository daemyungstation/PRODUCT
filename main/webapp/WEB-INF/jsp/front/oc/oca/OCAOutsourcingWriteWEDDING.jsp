										...
										<table summary="">
											...
											<tbody>
												...
												<c:if test="${info.sllrPartYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">소속(업체명)</span></th>
														<td>
															<input type="text" name="sllrPart" title="소속(업체명)" class="inputType1" maxlength="50" />
														</td>
													</tr>
												</c:if>
												...
												<c:if test="${info.agentEmpNmYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">판매사 성함</span></th>
														<td>
															<input type="text" name="agentEmpNm" title="판매사 성함" class="inputType1" maxlength="20" />
														</td>
													</tr>
												</c:if>
												...
												<c:if test="${info.sllrCtelYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">판매사 연락처</span></th>
														<td>
															<input type="text" name="sllrCtel" title="판매사 연락처" class="inputType1 phoneChk" maxlength="13" />
														</td>
													</tr>
												</c:if>
											</tbody>
										...
										<table summary="">
											...
											<tbody>
												...
												<c:if test="${info.nameYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">고객 명</span></th>
														<td>
												...
												<c:if test="${info.hpYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">고객 연락처</span></th>
														<td>
												...
												<!-- 계약 번호 -->
												<c:if test="${info.contractNoYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">계약 번호</span></th>
														<td>
															<span class="red"> * 웨딩의 여신 계약 번호 기재 </span><br/>
															<input type="text" name="contractNo" title="계약 번호" class="inputType1" maxlength="20" />
														</td>
													</tr>
                                                </c:if>
                                                
                                                <!-- 웨딩의 여신 초대코드 -->
												<c:if test="${info.inviteCodeYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="웨딩의 여신 친구 초대코드">웨딩의 여신 친구 <br>초대코드</span></th>
														<td>
                                                            <input type="text" name="inviteCode" title="웨딩의 여신 친구 초대코드" class="inputType1" maxlength="20" />
                                                            <span class="red">※ 웨딩의 여신 앱 포인트샵 → 친구초대 → 나의 친구 초대코드 확인</span>
														</td>
													</tr>
                                                </c:if>
												...
												<c:if test="${info.travelYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">희망 허니문 여행지</span></th>
														<td>
															<select name="travel" title="희망 허니문 여행지">
															...
															<span class="red">※ 기타 선택 시 메모에 입력</span>
														</td>
													</tr>
												</c:if>	

												<!-- 본 예식일 -->
												<c:if test="${info.weddingDateYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">희망 허니문 출발일</span></th>
														<td>
															<div class="date">
																<input type="text" id="telAbleDt" name="weddingDate" value="" title="희망 허니문 출발일" class="inputType1 datepicker_input" style="" readonly="readonly" />
												...
												<!-- 웨딩 견적 금액 -->
												<c:if test="${info.estimatePriceYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">웨딩 견적 금액</span></th>
														<td>
															<span class="red"> * 웨딩의 여신 확정 견적 금액 기재 </span><br/>
															<input type="text" name="estimatePrice" title="웨딩 견적 금액" class="inputType1 numberChk" maxlength="20" /> <strong>&nbsp; 만원</strong>
														</td>
													</tr>
												</c:if>
												...
												<c:if test="${info.joinProdYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">가입 희망 구좌</span></th>
														<td>
															  <input type="radio" name="joinProd" value="1구좌" id="joinProd1" title="가입 희망 구좌" checked> <label for="joinProd1" >1구좌</label>&nbsp;&nbsp;
  															  <input type="radio" name="joinProd" value="2구좌" id="joinProd2" title="가입 희망 구좌"> <label for="joinProd2">2구좌</label>
														</td>
													</tr>
												</c:if>
