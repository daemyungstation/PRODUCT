<%@ page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%><%@include file="/WEB-INF/jsp/include/el.jspf" %>
   						...
   						<h2 style="font-size: 36px; color: #333; line-height: 36px; margin-bottom: 30px; font-family: 'NanumSquareB'; font-weight: normal;">${info.title}</h2>
						<span class="red"><B>☎ 전용 콜센터 : 1661-2945</B></span>
									...
									<div class="boardType2 mt15">
										<table summary="">
											...
											<tbody>
												...
												<!-- 롯데카드 결제 상태 입력란 -->
												<c:if test="${info.lotteCardPayYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">롯데카드 결제 상태</span></th>
														<td>
															  <input type="radio" name="lotteCardPay" value="1" id="lotteCardPay1" title="롯데카드 결제 상태"> <label for="lotteCardPay1" >35개월 할부 결제 완료</label>&nbsp;&nbsp;
  															  <input type="radio" name="lotteCardPay" value="2" id="lotteCardPay2" title="롯데카드 결제 상태"> <label for="lotteCardPay2">35개월 할부 미 결제 (롯데카드 미 소지 포함)</label>
														</td>
													</tr>
												</c:if>	
												...
												<c:if test="${info.prdctNm2Yn eq 'Y'}">
													<tr>
														...
														<td>
															...
															&nbsp;&nbsp;<span class="red"> * 한 고객이 2구좌 가입(예정) 시 선택해주세요.</span>
														</td>
													</tr>
												</c:if>
												...
												<c:if test="${info.nameYn eq 'Y'}">
													<tr>	
														...
														<td>
															...
															<span class="red"> * 롯데카드 할부결제(예정) 고객과 동일해야 합니다.</span>
														</td>
													</tr>
												</c:if>
												...
												<!-- 여행 예약번호 입력란 -->
												<c:if test="${info.tourBookNoYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">여행예약번호</span></th>
														<td>
															<input type="text" name="tourBookNo" title="여행예약번호" class="inputType1" maxlength="20" />&nbsp;&nbsp;
															<span class="red"> * 가입을 위해서 여행예약번호가 반드시 필요합니다.</span>
														</td>
													</tr>
												</c:if>	
												...
												<c:if test="${info.memoYn eq 'Y'}">
													<tr>	
														...
														<td>
															<textarea name="memo" title="메모" class="inputType4 notRequired" style="height:60px;" maxlength="2000"></textarea>
														</td>
													</tr>
												</c:if>
											</tbody>
