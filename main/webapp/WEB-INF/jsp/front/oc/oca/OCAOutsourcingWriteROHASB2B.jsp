									...
									<div class="boardType2 mt15">
										<table summary="">
											...
											<tbody>
												...
												<!-- 카드결제 유무 선택란 -->
												<c:if test="${info.cardPayYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">카드결제 유무</span></th>
														<td>
															<select name="cardPay" title="카드결제 유무">
																<option value="">[선택해주세요]</option>
																<option value="Y">카드결제</option>
												...
												<c:if test="${info.contractorBirthYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">고객 생년월일</span></th>
														<td>
															<input type="text" name="contractorBirth" id="contractorBirth" title="고객 생년월일" class="inputType1 numberChk" maxlength="8" value="" />
															<span class="red" style="padding-left: 40px; font-weight: 700"> * 생년월일은 8자리로 입력해주세요. ex)19580101</span>
														</td>
													</tr>
												</c:if>
												<!-- 계약자 성별 입력란 -->
												<tr>
													<th scope="row"><span class="essen" title="필수입력">고객 성별</span></th>
													<td>
														<select name="sex" title="상품">
															<option value="">[선택해주세요]</option>
												...
												<c:if test="${info.hpYn eq 'Y'}">
													<tr>	
														...
														<td>
															...
															<input type="text" name="hp" title="고객 연락처" class="inputType1 phoneChk" maxlength="13" /> <span class="red" style="font-weight: 700;     padding-left: 40px;">* 1~2일 내 순차적으로 해피콜이 진행됩니다.
</span>
														</td>
													</tr>
												</c:if>
