							...
							<div data-controller="CommonController OutsourcingController">
											...
											<tbody>
												...
												<c:if test="${info.memoYn eq 'Y'}">
													<tr>	
														...
														<td>
															<textarea name="memo" title="메모" class="inputType4 notRequired" style="height:60px;" maxlength="2000" placeholder="스드메 패키지 희망 금액대 기재"></textarea>
														</td>
													</tr>
												</c:if>
											</tbody>
								...
								<c:if test="${info.termsYn eq 'Y'}">
									...
									<div class="termDiv mt40">
										...
										<div class="termBox">
										<p align="left">■개인 정보의 제3자 제공 동의<br>

										- 제공받는자 : 주식회사 디세이브<br>

										- 제공하는 개인정보 항목 : 성명, 연락처(휴대 전화번호), 이메일<br>

										- 제공받는 자의 개인정보 이용 목적 : 신청 서비스 상담 및 컨텐츠 제공, 상담을 위한 일정 및 정보제공(전화, E-DM발송)<br>

										- 보유기간 : 처리 종료 시<br>

										※ 귀하께서는 개인정보제공 및 활용에 거부할 권리가 있습니다.<br>

											거부에 따른 불이익 : 위 제공사항은 대명아임레디 웨딩 컨설팅 신청에 반드시 필요한 사항으로 거부할 경우 서비스 이용이 불가함을 알려드립니다.<br>
										</div>
									</div>
