											...
											<tbody>
												...
												<c:if test="${info.memoYn eq 'Y'}">
													<tr>	
														...
														<td>
															<textarea name="memo" title="메모" class="inputType4 notRequired" style="height:60px;" maxlength="2000" placeholder="희망 신청 지역 기재"></textarea>
														</td>
													</tr>
												</c:if>
											</tbody>
...
<!--  
									<div class="termDiv mt40">
										...
										※ 귀하께서는 개인정보제공 및 활용에 거부할 권리가 있습니다.<br>
											...
											거부에 따른 불이익 : 위 제공사항은 대명아임레디 하이브리드서비스 신청에 반드시 필요한 사항으로 거부할 경우 서비스 이용이 불가함을 알려드립니다.<br>
										</div>
									</div>
-->
								</c:if>
