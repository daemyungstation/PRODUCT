...
<%
	...
	// ########################################################################
	//String keyPath = "C:\\okname\\safecert_"+memId+"_test.key";		// 테스트 키파일(윈도우용)
	//String keyPath = "C:\\project\\#okname\\safecert_"+memId+"_mng.key";		// 테스트 키파일(윈도우용)
...
<script language="javascript" type="text/javascript" >
	function fncOpenerSubmit() {
		//console.log(opener.document.kcbResultForm);
...
<%	} %>
		...
		window.opener.returnMobileAuth();

		self.close();
/* 		opener.document.kcbResultForm.action = "/outsourcing/getPhoneAuthInfSMART.do";
