											...
											<tbody>
												...
												<c:if test="${info.agentNmYn eq 'Y'}">
													<tr>	
														...
														<td>
															<input type="radio" name="agentNm" value="KB사업부" id="agentNm1" title="대리점명" checked> <label for=agentNm1 >KB사업부</label>&nbsp;&nbsp;
  															<input type="radio" name="agentNm" value="직매장 사업부" id="agentNm2" title="대리점명"> <label for="agentNm2">직매장 사업부</label>
														</td>
													</tr>
												</c:if>
