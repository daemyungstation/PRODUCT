...
<div class="log-popup">
	<div class="log-popup-in">
		<h2>8월 게릴라 프로모션 안내<span class="ico"></span></h2>
		<div class="log-popup-box">
			<p class="txt-info">
				대명 유치 시<br>
				<span style="font-weight: 700; color: red; font-size: 24px" 건당 기본 수수료 2만원 추가</span> 지급<br><br>

				* 기간: 22.08.01~08.31<br>
				* 대상: 소매/도매 대리점<br>
				* 조건: 기간 內 신규 폴더블폰 개통 및 대명 가입 완료<br><br>

				(※ 자세한 내용은 LG유플러스 정책서를 확인해주세요.)
			</p>
		</div>
		<span style="border: solid 1px">X</span><h2>1 주일동안 안보기</h2>
	</div>
										...
										<table summary="">
											...
											<tbody>
														...
														<td style="display:flex;">
															<select id="prdctCd" name="prdctCd" title="상품">
																...
																<c:forEach var="list" items="${prdctList.product}">
																	<c:if test="${list.cd eq 'LGU9' || list.cd eq 'LGU10'}">
																		<option value="${list.cd}">${list.cdNm}</option>
																	</c:if>
																</c:forEach>
															</select>
												...
												<c:if test="${info.discountCtnYn eq 'Y'}">
													...
													<tr id="discount_ctn_10" style="display:none;">	
														<th scope="row">혜택 받을 IPTV 홈상품 번호</th>
														<td>
															<input type="text" name="discountCtn3_10" title="혜택 받을 IPTV 홈상품 번호" class="inputType1 notRequired" style="float: left; width: 264pxl"/>
															<div style="float: left;">
																<span class="red">※ 실제 혜택이 적용될 IPTV 홈상품 번호 정확히 기재</span><br>
																<span class="red">※ 미 기재 시, U-Cube 상담 등록 시, 가입번호로 혜택 적용</span>
															</div>
														</td>
													</tr>
													...
													<tr class="invisible1" style="display:none;">
														...
														<td>
															<select id="prdctCd2"name="prdctCd2" title="상품" class="notRequired">
																...
																<!--  
																<option value="LGU9">통신요금 960,000원 할인 상품</option>
																-->
															</select>
														</td>
													</tr>
												...
												<c:if test="${info.discountCtnYn eq 'Y'}">
													<tr id="discount_ctn2" style="display:none;">	
														<th scope="row"><span class="" title="필수입력">할인 받을 연락처(CTN)</span></th>
														<td>
															<input type="text" name="discountCtn2" title="할인 받을 연락처" class="inputType2 phoneChk notRequired" maxlength="13" style="float: left;"/>
															<div style="float: left;">
																<span class="red">※ 실제 혜택이 적용될 U+ CTN 정확히 기재</span><br>
																<span class="red">※ 미 기재 시, U-Cube 상담 등록 시, 가입번호로 혜택 적용</span>
															</div>
													...
													<tr id="discount_ctn2_10" style="display:none;">	
														<th scope="row">혜택 받을 IPTV 홈상품 번호</th>
														<td>
															<input type="text" name="discountCtn3_10" title="혜택 받을 IPTV 홈상품 번호" class="inputType2 notRequired" style="float: left; width: 264pxl"/>
															<div style="float: left;">
																<span class="red">※ 실제 혜택이 적용될 IPTV 홈상품 번호 정확히 기재</span><br>
																<span class="red">※ 미 기재 시, U-Cube 상담 등록 시, 가입번호로 혜택 적용</span>
															</div>
												...
												<c:if test="${info.discountCtnYn eq 'Y'}">
													<tr id="discount_ctn3" style="display:none;">	
														<th scope="row"><span class="" title="필수입력">할인 받을 연락처(CTN)</span></th>
														<td>
															<input type="text" name="discountCtn3" title="할인 받을 연락처" class="inputType3 phoneChk notRequired" maxlength="13" style="float: left;"/>
															<div style="float: left;">
																<span class="red">※ 실제 혜택이 적용될 U+ CTN 정확히 기재</span><br>
																<span class="red">※ 미 기재 시, U-Cube 상담 등록 시, 가입번호로 혜택 적용</span>
															</div>
													...
													<tr id="discount_ctn3_10" style="display:none;">	
														<th scope="row">혜택 받을 IPTV 홈상품 번호</th>
														<td>
															<input type="text" name="discountCtn3_10" title="혜택 받을 IPTV 홈상품 번호" class="inputType3 notRequired" style="float: left;  width: 264pxl"/>
															<div style="float: left;">
																<span class="red">※ 실제 혜택이 적용될 IPTV 홈상품 번호 정확히 기재</span><br>
																<span class="red">※ 미 기재 시, U-Cube 상담 등록 시, 가입번호로 혜택 적용</span>
															</div>
													...
													<tr>	
														...
														<td>
															<div>
																...
																<a href="javascript:" class="btn333" id="zipcodeDaum">우편번호 찾기</a>
															</div>
