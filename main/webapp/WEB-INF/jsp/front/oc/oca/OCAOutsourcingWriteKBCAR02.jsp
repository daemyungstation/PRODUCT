...
$(window).resize(function(){
	...
	if(width < 493){
		$(".log-popup-in").css("width","80%");
		$(".log-popup-in h2").css("width","80%");
	}else{
		$(".log-popup-in").css("width","400");
		$(".log-popup-in h2").css("width","400");
	}
}).resize();	
</script>
			...
			<tbody>
				...
				<c:if test="${info.orderNumYn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="orderNum" title="주문번호" class="inputType1 numberChk" value="${orderNum}"/>
							(숫자만 입력 가능)
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${info.contractorNameYn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="contractorName" title=계약자명 class="inputType1" value="${contractorName}"/>
						</td>
					</tr>
				</c:if>
				<!-- 계약자 연락처 입력란 -->
				<c:if test="${info.contractorPhoneYn eq 'Y'}">
					<tr>
						...
						<td>
							<input type="text" name="contractorPhone" title="계약자 연락처" class="inputType1 phoneChk" value="${contractorPhone}"/>
							(숫자만 입력 가능)
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${info.contractorBirthYn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="contractorBirth" title="계약자 생년월일" class="inputType1 numberChk" value="${contractorBirth}"/>
							(숫자만 입력 가능)
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${info.orderQtyYn eq 'Y'}">
					<tr>	
						...
						<td>
							...
							--%>
							<select name="orderQty" class="inputType1" title="주 계약 구좌 수">
				...
				<c:if test="${info.mainContService1Yn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="mainContService1" title="주계약 서비스1" class="inputType1" value="${mainContService1}"/>
						</td>
					</tr>
				</c:if>
				<!--  주계약 서비스2 입력란 -->
				<c:if test="${info.mainContService2Yn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="mainContService2" title="주계약 서비스2" class="inputType1 notRequired" value="${mainContService2}"/>
						</td>
					</tr>
				</c:if>
				<!-- 카드사 입력란 -->
				<c:if test="${info.cardCompanyYn eq 'Y'}">
					<tr>
						...
						<td>
							<input type="text" name="cardCompany" title="신용카드사" class="inputType1" value="${cardCompany}""/>
							(영어 대문자만 입력 가능)
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${info.creditCardNumYn eq 'Y'}">
					<tr>
						...
						<td>
							<input type="text" name="creditCardNum" title="카드번호" class="inputType1 numberChk" value="${creditCardNum}"/>
							(숫자만 입력 가능)
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${info.validThruYn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="validThru" title="유효기간" class="inputType1 numberChk" value="${validThru}" />
							(숫자만 입력 가능)
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${info.code2Yn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="code2" title="상사코드" class="inputType1 numberChk" value="${code2}"/>
							(숫자만 입력 가능)
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${info.agentNmYn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="agentNm" title="상사명" class="inputType1" value="${agentNm}"/>
						</td>
					</tr>
				</c:if>
				<!-- 담당자명 입력란 -->
				<c:if test="${info.agentEmpNmYn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="agentEmpNm" title="담당자명" class="inputType1" value="${agentEmpNm}"/>
						</td>
					</tr>
				</c:if>
				<!-- 담당자 연락처 입력란 -->
				<c:if test="${info.agentEmpTelYn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="agentEmpTel" title="담당자 연락처" class="inputType1 phoneChk" value="${agentEmpTel}"/>
							(숫자만 입력 가능)
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${info.plateNumYn eq 'Y'}">
					<tr>	
						...
						<td>
							<input type="text" name="plateNum" title="차량번호" class="inputType1" value="${plateNum}"/>
						</td>
					</tr>
				</c:if>
			</tbody>
...
<div class="termDiv mt40">
	...
	<div class="termBox">
		...
		<table class="terms_table">
			...
			<tr>
				<td>
					㈜브랜즈웰 / 효성ITX㈜<br style="font-size: 13.33px;">
...
*/
	...
	//신용카드사 영어대문자 변환
	$("input[name=cardCompany]").keyup(function(event){
