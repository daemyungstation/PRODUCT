										...
										<table summary="">
											...
											<tbody>
												...
												<c:if test="${info.mainContTypeYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">이용서비스(가전전환)</span></th>
														<td>
															<input type="text" name="mainContType" title="이용서비스(가전전환)" class="inputType1" maxlength="50" placeholder="원하시는 가전패키지">
															예) 삼성비스포크 냉장고 + 블루스카이 공기청정기
														</td>
													</tr>
												</c:if>			
