				...
				<div class="footDiv">
					...
					<div class="fUtil fbtns">
						...
						<select id="selectAflt" title="계열사 홈페이지 선택">
							...
							<option value="http://www.daemyung.com">대명 소노그룹</option>
							<option value="http://www.daemyungresort.com">소노호텔&리조트</option>
					...
					<p class="awardMark">
						...
						<a href='javascript:window.open("https://www.ucert.co.kr/trustlogo/sseal_cert.html?sealnum=07b5c735032a2d1c08d745ca1ec93ff81cd8a787329301235c908047bc4f6272&sealid=1052153389637f8545b5232d9ff940648bb0c6394e46b9a326244e5526a179e157b2d2b8ae0ce2a6e39e87bc54492dc9","mark","scrollbars=no,resizable=no,width=565,height=805");'>
							<img src="https://www.daemyungimready.com/common/images/icon/kisia.png"  align="absmiddle" style="cursor:hand; width: 71.74px; height:40px; padding-top: 5px; border: none;">
						</a>
						<!--KISA Certificate Mark-->
