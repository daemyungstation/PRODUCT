											...
											<tbody>
												...
												<c:if test="${info.jauNumYn eq 'Y'}">
													<tr>	
														...
														<td>
															<input type="text" name="jauNum" title="자유투어 예약번호" style="float:left;" class="inputType1" maxlength="20" />&nbsp;&nbsp;
												...
												<c:if test="${info.memoYn eq 'Y'}">
													<tr>	
														...
														<td>
															<textarea name="memo" title="메모" class="inputType4 notRequired" style="height:60px;"></textarea>
														</td>
													</tr>
												</c:if>
											</tbody>
