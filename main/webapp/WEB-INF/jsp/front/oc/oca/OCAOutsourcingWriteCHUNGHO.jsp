...
<form name="frm" method="post" action="/outsourcing/insert.do">
    ...
    <div data-controller="CommonController OutsourcingController">
        <c:if test="${info.agentInfoYn eq 'Y'}">
            <p class="titTxt mt40">영업담당자 정보 입력</p>
                ...
                <table summary="">
                    ...
                    <c:if test="${info.prepaidCardNumYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="prepaidCardNum" title="선불카드 번호" class="inputType1 numberChk"
                                       maxlength="8"/>
                    ...
                    <c:if test="${info.idNoYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="idNo" value="${dmEntrNo}" title="대명 가입 번호"
                                       class="inputType1 numberChk" style="border:0;" readonly="readonly"/>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.b2bEmpCdYn eq 'Y'}">
                        <tr>
                            <th scope="row"><span class="essen" title="필수입력">영업담당자 명</span></th>
                            <td>
                    ...
                    <c:if test="${info.agentEmpNumYn eq 'Y'}">
                        <tr>
                            <th scope="row"><span class="essen" title="필수입력">영업담당자 사번</span></th>
                            <td>
                                <input type="text" name="agentEmpNum" title="판매사원 사번" class="inputType1 numberChk"
                                       maxlength="20"/>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.agentEtcYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <textarea name="agentEtc" title="기타" class="inputType4 notRequired" style="height:60px;"
                    ...
                    <c:if test="${info.sllrPartYn eq 'Y'}">
                        <tr>
                            <th scope="row"><span class="essen" title="필수입력">영업담당자 소속</span></th>
                            <td>
                    ...
                    <c:if test="${info.agentEmpTelYn eq 'Y'}">
                        <tr>
                            <th scope="row"><span class="essen" title="필수입력">영업담당자 연락처</span></th>
                            <td>
                                <input type="text" name="agentEmpTel" title="담당자 연락처" class="inputType1 phoneChk"
                                       maxlength="13"/>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <!-- 판매 대리점명 -->
                    <c:if test="${info.sllrAgentNmYn eq 'Y'}">
                        <tr>
                            <th scope="row"><span class="essen" title="필수입력">판매 대리점명</span></th>
                            <td>
                                <input type="text" name="sllrAgentNm" title="판매 대리점명" class="inputType1"
                                       maxlength="20"/>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.sllrCtelYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="sllrCtel" title="판매자 연락처" class="inputType1 phoneChk"
                                       maxlength="13"/>
                            </td>
                        </tr>
                    </c:if>
        ...
        <c:if test="${info.customerInfoYn eq 'Y'}">
            ...
            <div class="boardType2 mt15">
                <table summary="">
                    ...
                    <tr>
                        <th scope="row"><span class="essen" title="필수입력" style="color: red">계약 번호 (16자리)</span></th>
                        <td>
                            <input type="text" name="contractNo1" title="계약번호" placeholder="2자리" class="numberChk" maxlength="2" style="width: 10%;"/>
                            <input type="text" name="contractNo2" title="계약번호" placeholder="7자리" class="numberChk" maxlength="7" style="width: 20%;"/>
                            <input type="text" name="contractNo3" title="계약번호" placeholder="2자리" class="numberChk" maxlength="2" style="width: 10%;"/>
                            <input type="text" name="contractNo4" title="계약번호" placeholder="5자리" class="numberChk" maxlength="5" style="width: 15%;"/>
                        </td>
                    </tr>
                    ...
                    <c:if test="${info.fusionPrdctYn eq 'Y'}">
                        <tr>
                            <th scope="row"><span class="essen" title="필수입력">제품군</span></th>
                            <td>
                                <select name="productNm" title="제품군">
                                    <option value="">[제품선택]</option>
                                    <option value="정수기">정수기</option>
                                    <option value="공기청정기">공기청정기</option>
                                    <option value="기타">기타</option>
                                </select>
                                <input type="text" name="fusionPrdctSerialNum" title="모델명" placeholder="모델명" class="inputType1" />
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.telYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tel" title="고객 연락처" class="inputType1 phoneChk notRequired"
                                       maxlength="13"/>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.dmTourNumYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="dmTourNum" title="대명투어몰 예약번호" class="inputType1"
                                       maxlength="20"/>&nbsp;&nbsp;
                    ...
                    <c:if test="${info.lotteCardYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="lotteCard" value="1" id="lotteCard1" title="롯데카드 발급 상태">
                                <label for="lotteCard1">실물 카드 보유</label>&nbsp;&nbsp;
                                <input type="radio" name="lotteCard" value="2" id="lotteCard2" title="롯데카드 발급 상태">
                                <label for="lotteCard2">신규 발급 (실물카드 수령 전)</label>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.addressYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input type="text" id="zipcd" name="zipcd" class="inputType3 add1 notRequired"
                                           maxlength="7" readonly="readonly"/>
                                    <input type="text" name="adr" class="inputType5" maxlength="100"
                                           readonly="readonly"/>
                                    <a href="javascript:" class="btn333" id="zipcode">우편번호 찾기</a>
                                </div>
                                <p class="mt10"><input type="text" name="adr_dtl" title="상세주소" class="inputType4"
                                                       maxlength="100" placeholder="상세주소"/></p>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.cstmrUnqNumYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cstmrUnqNum" title="고객 고유번호" class="inputType1"
                                       maxlength="20"/>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.cardNumYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cardNum" title="카드번호" class="inputType1 notRequired"
                                       maxlength="20"/>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.cstmrEtcYn eq 'Y'}">
                        <tr>
                            <th scope="row"><span>기타</span></th>
                            <td>
                                <textarea name="cstmrEtc" title="기타" class="inputType4 notRequired" style="height:60px;"
                                          maxlength="2000"></textarea>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test="${info.hanssMbspNumYn eq 'Y'}">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="hanssMbspNum" title="한샘 통합 멤버십" class="inputType1"
                                       maxlength="9"/>&nbsp;&nbsp;
                    ...
                    <c:if test="${info.memoYn eq 'Y'}">
                        <tr>
                            <th scope="row"><span style="padding-left:0;">메모</span><span
                                    style="display: block;font-size: 12px;color: #b12b1d;padding-top: 8px;padding-left:0;">※글자수 250자 제한</span>
                            </th>
                            <td>
                                <textarea name="memo" title="메모" class="inputType4 notRequired" style="height:60px;"
        ...
        <c:if test="${info.termsYn eq 'Y'}">
            <div class="termDiv mt40">
                <p class="tit">개인 정보 활용 동의 안내 (필수)</p>
