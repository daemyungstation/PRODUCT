...
<h2 style="font-size: 36px; color: #333; line-height: 36px; margin-bottom: 50px; font-family: 'NanumSquareB'; font-weight: normal;">스마트라이프 실적 조회</h2>
...
<script type="text/javascript">
    ...
    function callApi(pageNum) {
        if (document.getElementById('checkAuth').value == 'Y') {
            ...
            jQuery.ajax({
                url : "/smart-life/userRecord.ajax",
                type : "POST",
                data : {
