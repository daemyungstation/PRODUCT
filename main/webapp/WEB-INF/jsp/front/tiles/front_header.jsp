...
<html lang="ko">
	<head>		
		...
		<meta name="naver-site-verification" content="6b34a18682ba6578cac42877a7c865a026aabaa8"/>
			...
			<div id="header">
				<div class="headDiv">
					...
					<div class="util">
						...
						<c:choose>
							<c:when test="${agreementForThirdParty eq 'Y'}">
								<a href="http://www.daemyungresort.com/mv.dp/dmparse.dm?menuCd=5551000" class="mbcardBtn mbResortBtn2 btnResortY" target="_blank">리조트예약</a>
							</c:when>
							<c:otherwise>
								<a href="/my-lifeway/member/resortagree/index.do" class="mbcardBtn mbResortBtn2 btnResortN" onclick="alert('대명리조트 예약을 위해서는 개인정보 제 3자 제공에 동의하셔야 합니다.\n나의 라이프웨이 리조트 객실 예약을 위한 개인정보 제공동의페이지로 이동합니다.');">리조트예약</a>
							</c:otherwise>
						</c:choose>
					...
					<div class="mbBtns">
						...
						<c:choose>
							<c:when test="${agreementForThirdParty eq 'Y'}">
								<a href="http://www.daemyungresort.com/mv.dp/dmparse.dm?menuCd=5551000" class="mbcardBtn2 mbResortBtn2 btnResortY" target="_blank">리조트예약</a>
							</c:when>
							<c:otherwise>
