...
<%@include file="./CheckDomain.jsp" %>
						...
						$(document).ready(function(){
							...
							$("#prdctCd2").change(function() {
								alert(prdctCd2.value);
								if(prdctCd2.value) {
									$("input:radio[name='mainContType2']").removeClass("notRequired");
								} else {
									$("input:radio[name='mainContType2']").addClass("notRequired");
								}
							});
						});
						</script>
										...
										<table summary="">
											...
											<tbody>
												...
												<c:if test="${info.agentEmpNmYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">사원 명</span></th>
														<td>
															<input type="text" name="agentEmpNm" title="사원 명" class="inputType1" maxlength="20" />
														</td>
													</tr>
												</c:if>
												...
												<c:if test="${info.sllrAgentNmYn eq 'Y'}">
													<tr>
														...
														<td>
															<input type="text" name="sllrAgentNm" title="판매 대리점명" class="inputType1" maxlength="20" />
														</td>
													</tr>
												</c:if>
												...
												<c:if test="${info.sllrCtelYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">연락처 (핸드폰)</span></th>
														<td>
															<input type="text" name="sllrCtel" title="연락처 (핸드폰)" class="inputType1 phoneChk" maxlength="13" />
														</td>
													</tr>
												</c:if>
												...
												<c:if test="${info.sllrPartYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">지사</span></th>
														<td>
															<input type="text" name="sllrPart" title="지사" class="inputType1" maxlength="50" />
															<span>지사&nbsp</span>
															<span class="red">※ 소속 '지사' 입력</span>
														</td>
													</tr>
												</c:if>
												...
												<c:if test="${info.agentEmpNumYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">사번</span></th>
														<td>
															<input type="text" name="agentEmpNum" title="사번" class="inputType1" maxlength="20" />
															<span class="red">※ 8자리 '사번' 입력</span>
														</td>
													</tr>
												</c:if>
											</tbody>
										...
										<table summary="">
											...
											<tbody>
												...
												<c:if test="${info.prdctNmYn eq 'Y'}">
													<tr>
														<th scope="row"><span class="essen" title="필수입력">1구좌 상품 선택</span></th>
														<td>
												...
												<c:if test="${info.mainContTypeYn eq 'Y'}">
													<tr>	
														<th scope="row"><span class="essen" title="필수입력">1구좌 상품 주계약</span></th>
														<td>
															<input type="radio" name="mainContType" value="여행" id="firstContType2" title="주 계약"> <label for="mainContType2" >여행</label>&nbsp;&nbsp;
  															<input type="radio" name="mainContType" value="크루즈" id="firstContType3" title="주 계약"> <label for="mainContType3">크루즈</label>&nbsp;&nbsp;
															<input type="radio" name="mainContType" value="골프" id="firstContType4" title="주 계약"> <label for="mainContType4" >골프</label>&nbsp;&nbsp;
															<input type="radio" name="mainContType" value="상조" id="firstContType1" title="주 계약"> <label for="mainContType1" >상조</label>&nbsp;&nbsp;										
															<input type="radio" name="mainContType" value="어학연수" id="firstContType5" title="주 계약"> <label for="mainContType5" >어학연수</label>
														</td>
													</tr>
												</c:if>
												<!-- 상품2 선택란 -->
												<c:if test="${info.prdctNm2Yn eq 'Y'}">
													<tr>
														<th scope="row"><span>2구좌 상품 선택</span></th>
														<td>
															...
															<span class="red">※ 2구좌 가입 신청 시, 선택</span>
														</td>
													</tr>
												</c:if>
												<!-- 주 계약2 -->
												<c:if test="${info.mainContTypeYn eq 'Y'}">
													<tr>
														<th scope="row"><span>2구좌 상품 주계약</span></th>
														<td>
															<input class="notRequired" type="radio" name="mainContType2" value="여행" id="secondContType1" title="주 계약"> <label for="mainContType1" >여행</label>&nbsp;&nbsp;
  															<input class="notRequired" type="radio" name="mainContType2" value="크루즈" id="secondContType2" title="주 계약"> <label for="mainContType2">크루즈</label>&nbsp;&nbsp;
															<input class="notRequired" type="radio" name="mainContType2" value="골프" id="secondContType3" title="주 계약"> <label for="mainContType3" >골프</label>&nbsp;&nbsp;
															<input class="notRequired" type="radio" name="mainContType2" value="상조" id="secondContType4" title="주 계약"> <label for="mainContType4" >상조</label>&nbsp;&nbsp;
															<input class="notRequired" type="radio" name="mainContType2" value="어학연수" id="secondContType5" title="주 계약"> <label for="mainContType5" >어학연수</label>
														</td>
													</tr>
												</c:if>
												<!-- 상품3 선택란 -->
												...
												<c:if test="${info.memoYn eq 'Y'}">
													<tr>	
														...
														<td>
															<span class="red"> * 특이사항 기재 시, 상담 진행이 수월합니다.</span>
