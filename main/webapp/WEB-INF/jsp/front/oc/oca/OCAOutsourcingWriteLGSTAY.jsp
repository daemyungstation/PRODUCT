			...
			<tbody>
				...
				<c:if test="${info.fusionPrdctYn eq 'Y'}">
					<tr>
						...
						<td>
							<select id="fusionPrdctCd" name="fusionPrdctCd" title="결합상품">
								<option value="">[상품선택]</option>
							</select>
						</td>
					</tr>
				...
				<c:if test="${info.prdctNm2Yn eq 'Y'}">
					<tr>
						...
						<td>
							...
							&nbsp;&nbsp;
							<span class="red"> * 2구좌 선택 시(선택사항)</span>
						</td>
					</tr>
				</c:if>
				
				<!-- 결합 상품2 선택란 -->
				<c:if test="${info.fusionPrdct2Yn eq 'Y'}">
					<tr>
						<th scope="row"><span title="결합상품2">결합상품 선택2</span></th>
						<td>
							<select id="fusionPrdctCd2" name="fusionPrdctCd2" title="결합상품" class="notRequired">
								<option value="">[상품선택]</option>
							</select>
						</td>
					</tr>
