...
public class OCAOutsourcingDAO extends EmfAbstractDAO {
	 ...
	 * @throws 비지니스 로직이나 DAO 처리 중 에러가 발생할 경우 Exception을 Throw 한다.
     */
	public void insertOutsourcingInfEle(EmfMap emfMap) throws Exception 
	{
		insert("OCAOutsourcingDAO.insertOutsourcingInfEle", emfMap);
    }
	 ...
	 * @throws 비지니스 로직이나 DAO 처리 중 에러가 발생할 경우 Exception을 Throw 한다.
     */
	public void insertOutsourcingInfEleInfo(EmfMap emfMap) throws Exception 
	{
		insert("OCAOutsourcingDAO.insertOutsourcingInfEleInfo", emfMap);
    }
	...
	{
		return (EmfMap)selectByPk("OCAOutsourcingDAO.selectOutsourcingLGUPageMngInfo", emfMap);
	}	
	...
	public EmfMap selectOverrapSidEle(EmfMap emfMap) throws Exception 
    {
    	return (EmfMap)selectByPk("OCAOutsourcingDAO.selectOverrapSidEle", emfMap);
    }
	...
	public int selectTelegramNo(EmfMap emfMap) {
